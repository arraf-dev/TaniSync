...
class DataSecurityWorkflowTest extends TestCase
{
    ...
    public function test_admin_registration_requires_approval(): void
    {
        ...
        $this->assertDatabaseHas('activity_logs', [
            'action' => 'admin_registered_pending',
            'subject_id' => $user->id,
        ]);
    }
    ...
    public function test_active_admin_can_approve_and_reject_admin_requests(): void
    {
        ...
        $pending = User::factory()->create(['role' => 'admin', 'account_status' => 'pending', 'approved_at' => null]);
        $rejected = User::factory()->create(['role' => 'admin', 'account_status' => 'pending', 'approved_at' => null]);
    ...
    {
        $admin = User::factory()->create(['role' => 'admin', 'account_status' => 'active']);
        [$commodity, $market] = $this->catalogFixture();
    ...
    public function test_farmer_harvest_history_only_shows_own_records(): void
    {
        ...
        $otherFarmer = User::factory()->create(['role' => 'petani', 'name' => 'Petani Lain']);
        [$commodity] = $this->catalogFixture();
